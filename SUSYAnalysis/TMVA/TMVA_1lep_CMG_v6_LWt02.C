...
// ----------------------------------------------------------------------------------------------
//
int TMVA_1lep_CMG_v6_LWt02(TString myMethodList = "" ){
   ...
   if (myMethodList != "") {
      ...
      for (UInt_t i=0; i<mlist.size(); i++) {
		...
		string inputFolder = "./2016_BKG_friends_nonsplit/Training_T02/";
	
   Double_t signalWeight      = 1.0;
   Double_t backgroundWeight = 1.0;
   Double_t lumi=35.9 ;
   // Create a new root output file.
   TString outfileName( "TMVA_BDT_T1tttt_1750_1000_nonsplit.root" );
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );
   // ____________
   TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification", outputFile, factoryOptions );
   TMVA::DataLoader *dataloader=new TMVA::DataLoader("TMVA_BDT_T1tttt_1750_1000_nonsplit");
...
//	dataloader->AddBackgroundTree(tree_DYJetsToLL_M50_HT100to200_ext		,	1);
   ...
   //dataloader->AddVariable("nDeepTop_tight"  ,"nDeepTop_tight"  ,
	...
	TString SMS_T1tttt_TuneCUETP8M1_2="2016_Sig_Training/evVarFriend_SMS_T1tttt_TuneCUETP8M1_1750_1000.root";
...
int main( int argc, char** argv )
{
   ...
   return TMVA_1lep_CMG_v6_LWt02(methodList);
}
